...
if(motoman_euclidean_cluster_CONFIG_INCLUDED)
  return()
endif()
set(motoman_euclidean_cluster_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(motoman_euclidean_cluster_SOURCE_PREFIX /home/robotica/sia5_ws/src/motoman_project/motoman_recognition/motoman_euclidean_cluster)
  set(motoman_euclidean_cluster_DEVEL_PREFIX /home/robotica/sia5_ws/devel)
  set(motoman_euclidean_cluster_INSTALL_PREFIX "")
  set(motoman_euclidean_cluster_PREFIX ${motoman_euclidean_cluster_DEVEL_PREFIX})
else()
  set(motoman_euclidean_cluster_SOURCE_PREFIX "")
  set(motoman_euclidean_cluster_DEVEL_PREFIX "")
  set(motoman_euclidean_cluster_INSTALL_PREFIX /home/robotica/sia5_ws/install)
  set(motoman_euclidean_cluster_PREFIX ${motoman_euclidean_cluster_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'motoman_euclidean_cluster' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND motoman_euclidean_cluster_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robotica/sia5_ws/install/lib;/home/robotica/final_ws/devel/lib;/home/robotica/lab_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(motoman_euclidean_cluster_LIBRARY_DIRS ${lib_path})
      list(APPEND motoman_euclidean_cluster_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'motoman_euclidean_cluster'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND motoman_euclidean_cluster_LIBRARIES ${lib})
    endif()
  endif()
...
set(motoman_euclidean_cluster_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${motoman_euclidean_cluster_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "motoman_viz_msgs;pcl_conversions;pcl_ros;roscpp;rospy;sensor_msgs;std_msgs;tf")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 motoman_euclidean_cluster_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${motoman_euclidean_cluster_dep}_FOUND)
      find_package(${motoman_euclidean_cluster_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${motoman_euclidean_cluster_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(motoman_euclidean_cluster_INCLUDE_DIRS ${${motoman_euclidean_cluster_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(motoman_euclidean_cluster_LIBRARIES ${motoman_euclidean_cluster_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${motoman_euclidean_cluster_dep}_LIBRARIES})
  _list_append_deduplicate(motoman_euclidean_cluster_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(motoman_euclidean_cluster_LIBRARIES ${motoman_euclidean_cluster_LIBRARIES})

  _list_append_unique(motoman_euclidean_cluster_LIBRARY_DIRS ${${motoman_euclidean_cluster_dep}_LIBRARY_DIRS})
  list(APPEND motoman_euclidean_cluster_EXPORTED_TARGETS ${${motoman_euclidean_cluster_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${motoman_euclidean_cluster_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
