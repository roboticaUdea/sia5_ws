...
"""autogenerated by genpy from motoman_viz_msgs/BoundingBoxArray.msg. Do not edit."""
import codecs
import sys
...
class BoundingBoxArray(genpy.Message):
  _md5sum = "98a348ec541453ab2bc2636b7a7df5f3"
  _type = "motoman_viz_msgs/BoundingBoxArray"
...
float64 z"""
  ...
  _slot_types = ['std_msgs/Header','motoman_viz_msgs/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = motoman_viz_msgs.msg.BoundingBox()
        _v7 = val1.header
        start = end
        end += 4
